...
@implementation TuwanImageTableViewCell
-(UILabel *)titleLb{
    if (_titleLb==nil) {
...
/**图片  宽高相等 */
        ...
        //topMargin和top的不同,  topMargin是用于上边缘对齐的,top是用于距离
