...
@class HeroDetailBraumQModel,HeroDetailBraumRModel,HeroDetailBraumWModel,HeroDetailBraumBModel,HeroDetailBraumEModel,HeroDetailLikeListModel,HeroDetailHateListModel;


@interface HeroDetailModel : BaseModel

@property (nonatomic, copy) NSString *ratingAttack;
@property (nonatomic, strong) HeroDetailBraumWModel *BraumW;//Braum_W
@property (nonatomic, copy) NSString *Id;//id
@property (nonatomic, copy) NSString *healthLevel;
@property (nonatomic, strong) HeroDetailBraumQModel *BraumQ;//Braum_Q
...
@property (nonatomic, strong) NSArray<HeroDetailHateListModel *> *hate;
@property (nonatomic, strong) HeroDetailBraumEModel *BraumE;//Braum_E
...
@property (nonatomic, strong) NSArray<HeroDetailLikeListModel *> *like;
...
@property (nonatomic, strong) HeroDetailBraumBModel *BraumB;//Braum_B
@property (nonatomic, copy) NSString *tips;
@property (nonatomic, copy) NSString *title;
@property (nonatomic, copy) NSString *healthRegenLevel;
@property (nonatomic, copy) NSString *ratingMagic;
@property (nonatomic, strong) HeroDetailBraumRModel *BraumR;//Braum_R
...
@property (nonatomic, copy) NSString *desc;//desc  description
...
@interface HeroDetailLikeListModel : NSObject
...
@interface HeroDetailHateListModel : NSObject
